...
public class playerScript_ex01 : MonoBehaviour
{
    ...
    void Update()
    {
        if (players[0].GetComponent<playerScript_ex01>().exited == true && players[1].GetComponent<playerScript_ex01>().exited == true && players[2].GetComponent<playerScript_ex01>().exited == true)
